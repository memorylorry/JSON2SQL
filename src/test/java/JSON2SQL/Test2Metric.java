...
public class Test2Metric {
    public static void main(String[] args) throws JSON2SQLParseException {
        ...
        String jsonStr = "{\"title\":\"a\",\"database\":\"dm\",\"table\":\"dm_total_user_profile\",\"type\":\"bar\",\"type_val\":3,\"dimension\":[{\"expression\":\"age\",\"name\":\"d0\",\"verbose\":\"年龄\"}],\"metric\":[{\"expression\":\"count(member_no)\",\"name\":\"m0\",\"verbose\":\"人数\"}],\"subMetric\":[{\"expression\":\"count(member_no)\",\"name\":\"m1\",\"verbose\":\"人数2\"}],\"filter\":[{\"expression\":\"age\",\"name\":\"c4955\",\"type\":0,\"optionText\":\"\",\"operation\":\"lg_date_fun\",\"verbose\":\"年龄\",\"sql\":\"\",\"option\":\"last_week\"}],\"order\":[{\"expression\":\"age\",\"name\":\"c4955\",\"type\":0,\"operation\":\"asc\",\"verbose\":\"年龄\",\"sql\":\"\"}],\"limit\":\"100\"}";
